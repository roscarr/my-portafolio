...
function Contact() {
  return (
    <div
      className=" h-screen flex flex-col justify-evenly items-center max-w-screen-xl mx-auto text-center "
      id="contact"
    >
      <h3 className=" text-2xl pt-10 uppercase tracking-[20px]">Contact Me</h3>
